      ...
      <div className="max-w-[520px] space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(event) =>
              updateTranslate({ hotkey_translate: event.target.value })
            }
          />
        </div>
        ...
        {!translate.auto_detect_language ? (
          <div className="grid grid-cols-[160px_1fr] gap-4 rounded-md border border-border bg-background p-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="reverse-hotkey">
                Горячая клавиша обратного перевода
              </Label>
              <Input
                id="reverse-hotkey"
                value={translate.hotkey_reverse}
                onChange={(event) =>
                  updateTranslate({ hotkey_reverse: event.target.value })
                }
              />
            </div>
          </div>
